...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
   @include('dashboard.app_logo')

   @include('layouts.left_bar.app_menu')
    ...
    <div class="c-wrapper c-fixed-components">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <div class="c-subheader px-3">
          ...
          <div style="position: absolute; right: 0; margin-right: 20px; margin-top: 5px; color: #fff;">
              <a class="btn bg-gradient-primary p-2" data-toggle="modal" data-target="#shipping">New Shipping</a>
          </div>
        </div>
      </header>
      <div class="c-body">
...
<div class="modal fade modalMainBackground" id="shipping" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-header" style="border: none;">
      <button class="close" type="button" data-dismiss="modal" aria-label="Close">
         <span aria-hidden="true" class="topCloseBtn formReset">×</span>
      </button>
   </div>
   <div class="changeDialog card shadow" role="document" style="border: none;">
      ...
      <div class="modal-body formContainer">
            <div class="alert alert-info shadow write-result">
               Calculate the amount of shipping from UK or US to Nigeria

                
            </div>
            <div class="SubmitLoader newLoader" style="margin-top:-55px; float:right; margin-right:10px; display: none;">
               </div>
         <div class="form-div">
            <form class="shippingForm" action="{{ route('shipping.store')}}" method="post">
               @csrf
               ...
               <div class="input-group mb-3">
                  <select class="form-control trans_mode" name="trans_mode">
                     <option>Select Mode of Transportation</option>
                     <option>Base Fare by Air</option>
                     <option>Base Fare by Sea</option>
                  </select>
               </div>

               <label>Select Item Weight in kilogram</label>
               <div class="input-group mb-4">
                <input class="form-control kilo_weight" type="number" min="1" value="1" name="kilo_weight">
              </div>


               <div class="input-group mb-3">
                  <input class="form-control shipping_email" type="text" placeholder="Enter Your Email Address" name="email">
               </div>

                <button class="submit-btn" type="submit" style="display: none;">Submit</button>

                <button class="btn btn-block bg-gradient-info click-submit-btn" type="button">Submit</button>
              
               <div class="SubmitLoader Loader" style="margin-top:-32px; float:right; margin-right:10px; display: none;">
               </div>
            </form>
         </div>
...
/*
===================================================================================================
start of calculating by shipping transaction
===================================================================================================
*/
      $(document).on('change', ".country, .trans_mode, .kilo_weight", function(){
         $(".threx-loader").show();

         country = $('select[name="country"]').val();
         trans_mode = $('select[name="trans_mode"]').val();
         kilo_weight = $('input[name="kilo_weight"]').val();
...
/*
===================================================================================================
end of calculating by shipping transaction
===================================================================================================
*/
...
/*
===================================================================================================
start of submitting transaction
===================================================================================================
*/    
      $(".click-submit-btn").on('click', function(){
         $(".submit-btn").click();
      ...
      $(document).on('submit', ".shippingForm", function(e){
         ...
         $.ajax({
            ...
            processData: false,
            success: function(value){
               if( value != "Please Select Country and Transaction Mode"){
                   $(".write-result").html("<h2> Total Payment: " + value + "</h2>");
...
/*
===================================================================================================
start of paystack payment function
===================================================================================================
*/
...
function payWithPaystack(){
    ...
    var handler = PaystackPop.setup({
      key: 'pk_test_b3ce39c3fe7af4a50a23428135c799db8c43931b',
      ...
      callback: function(response){
         $(".newLoader").show();
         $(".write-result").html("<h3> Processing your Transaction Details....<h3>");
        $.ajax({
        url:"{{ route('dashboard.paystack_response')}}",
        method:"GET",
        data:{
...
/*
===================================================================================================
end of paystack payment function
===================================================================================================
*/
